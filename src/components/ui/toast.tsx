...
function ToastViewport({ className, ...props }: ToastPrimitives.ToastViewportProps) {
  return (
...
function ToastAction({ className, ...props }: ToastPrimitives.ToastActionProps) {
  return (
...
function ToastClose({ className, ...props }: ToastPrimitives.ToastCloseProps) {
  return (
    <ToastPrimitives.Close
      className={cn(
        'absolute right-2 top-2 flex h-11 w-11 items-center justify-center rounded-md text-foreground/50 opacity-0 transition-opacity hover:text-foreground focus:opacity-100 focus:outline-none focus:ring-2 group-hover:opacity-100 group-[.destructive]:text-red-300 group-[.destructive]:hover:text-red-50 group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-red-600',
        className,
      )}
      toast-close=""
      {...props}
...
function ToastDescription({ className, ...props }: ToastPrimitives.ToastDescriptionProps) {
  return <ToastPrimitives.Description className={cn('text-sm opacity-90', className)} {...props} />
}
function ToastTitle({ className, ...props }: ToastPrimitives.ToastTitleProps) {
